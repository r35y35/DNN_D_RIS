# -*- coding: utf-8 -*-
"""
Created on Thu Feb 23 14:53:00 2023
...
class plotter_convergence:
    ...
    def plot(self, plotting = None,title="DDPG", ax="Episodes", ay="EE ", grid=1, smoother=1, fig=1):
        if plotting is None:
    ...
    def plot_result(self, title ="(DDPG) EE Vs BS-USer Horizontal Distance",
