# -*- coding: utf-8 -*-
"""
Created on Sun Mar 19 17:39:21 2023
...
class plotter_convergence:
    ...
    def plot(self, plotting = None,title="TD3", ax="Episodes", ay="Received SNR (dB)",legend = "D = ",grid=1, smoother=1, fig=1):
        if plotting is None:
        ...
        for i0 in range(self.num_fig):
            ...
            plt.plot(axis_set, rate_set, linewidth=1, label=legend+str(self.label[i0]))
            ...
            # plt.title('RandPhase Scenario', fontsize='small', fontweight='bold')
        plt.show() 
    ...
    def plot_result(self, title ="(TD3) Received SNR Vs BS-USer Horizontal Distance",
